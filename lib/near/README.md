...
| Cost optimization       | Service selection                 | Use cost effective resources                                                     | 1/ x86_64 instances are used by default for NEAR compatibility and good price/performance. 2/ Cost-effective EBS gp3 volumes are used. 3/ NEAR nodes can generate substantial outbound traffic - use NEAR_LIMIT_OUT_TRAFFIC_MBPS to control costs. |
|                         | Cost awareness                    | Estimate costs                                                                   | Single RPC node with `m7a.2xlarge` and EBS gp3 volumes will cost approximately $500-800 per month in US East (N. Virginia) region with On-Demand pricing. Data transfer costs can add $500-2000+ per month for high-traffic RPC nodes. Use [AWS Pricing Calculator](https://calculator.aws/) for estimates. |
...
| Performance efficiency  | Compute selection                 | How is compute solution selected?                                                | Compute solution is selected based on best price-performance and NEAR compatibility, i.e. x86_64 Amazon EC2 instances. |
...
| Sustainability          | Hardware & services               | Select most efficient hardware for your workload                                 | The solution uses efficient x86_64 Amazon EC2 instances optimized for NEAR Protocol workloads. |
</details>
...
|---|---|---|---|---|
| 1/ RPC node (archival=false) | 16 vCPU, 64 GiB RAM, Data volume: 1TB, 6K IOPS, 250 MB/s throughput | m7a.2xlarge, Data volume: EBS gp3, 1TB, 6K IOPS, 250 MB/s throughput | 10-50TB/month | [.env-sample](./sample-configs/single-testnet.env) |
| 2/ Archival RPC node | 32 vCPU, 128 GiB RAM, Data volume: 4TB, 10K IOPS, 250 MB/s throughput | m7a.4xlarge, Data volume: EBS gp3, 4TB, 10K IOPS, 250 MB/s throughput | 20-100TB/month | [.env-sample-archival](./sample-configs/ha-rpc-mainnet.env) |
</details>
